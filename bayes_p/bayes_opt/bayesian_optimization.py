...
class BayesianOptimization(Observable):
    ...
    def __init__(
        ...
        self.is_constrained_w = False
        #if constraint is None:
        if constraint is None and constraint_w is None:
            ...
            self._space = TargetSpace(
                target_func=f, pbounds=pbounds, random_state=random_state, allow_duplicate_points=self._allow_duplicate_points,constraint_w=constraint_w
            )
    ...
    def register(
        ...
        """
        self._space.register(params=params, target=target, constraint_value=constraint_value,constraint_value_w=constraint_value_w)
