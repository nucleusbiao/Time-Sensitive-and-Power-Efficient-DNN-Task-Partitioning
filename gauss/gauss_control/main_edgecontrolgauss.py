...
def commuicatethread(device,port):
    ...
    while True:
        ...
        #若收到请求信息，启动进程
        startargs='python3 '+str(this_dir)+ '/maintagentbbatch_ljdan_powernew_guass_s.py  --ports='+str(receive[1])+' --dnns='+str(receive[0]+' --totalnumber='+str(totalnumber)+' --username='+device)
